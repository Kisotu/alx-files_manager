...
import Mailer from './utils/mailUtil';
...
userQueue.process(async (job, done) => {
  ...
  try {
    ...
    const mailContent = [
      ...
      'Welcome to <a href="https://github.com/Kisotu/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/Kisotu">Kisotu Jake</a>. ',
      'Your technical needs expert.',
      '</div>',
    ].join('');
